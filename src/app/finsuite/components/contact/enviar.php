...
$from = 'Web SyS <web@gruposysconstrucciones.com.ar>';

// an email address that will receive the email with the output of the form
$sendTo = 'web@gruposysconstrucciones.com.ar';
...
$errorMessage = 'Hubo un error, por favor vuelva a intentarlo o contáctenos por Whatsapp.';
